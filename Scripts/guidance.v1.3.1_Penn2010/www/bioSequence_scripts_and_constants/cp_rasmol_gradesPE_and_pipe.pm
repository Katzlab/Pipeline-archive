...
<li>Start PyMOL.</li>
<li>Load the pdb file; In the PyMOL viewer window type:<br>
<font face=Courier New>PyMOL>\"load <b>PDB_FILE</b>\"</font><br>
(no quotes) and hit return.<br>
</li>
Run the script to define ConSurf\'s color; Type:<br>
<font face=Courier New>PyMOL>\"run <b>consurf_new.py</font></b>\" <br>
     (no quotes) and hit return.<br>
</li>
<li>Run the coloring scheme; Type this command:<br>
<font face=Courier New>PyMOL>\"colour_consurf\"</font><br>
</li>
</ol></body></html>
